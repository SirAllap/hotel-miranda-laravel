		...
		<section class="aboutus-intro__video-services">
			...
			<div class="aboutus-intro__services">
				...
				<div class="aboutus-intro__services-card">
					<img src="images/assets/images/aboutus_services/BREAKFAST.png" alt="an illustration of a cup and croissant as a breakfast" />
					<img src="images/assets/images/aboutus_services/AIRPORT.png" alt="an illustration of a plane" />
				</div>
				<div class="aboutus-intro__services-card">
					<img src="images/assets/images/aboutus_services/CITI GUIDE.png" alt="an illustration of a citi guide" />
					<img src="images/assets/images/aboutus_services/LUXURY.png" alt="an illustration of a luxury room" />
				</div>
			</div>
		</section>
		<section class="aboutus-intro__restaurant">
			<img src="images/assets/images/aboutus_services/aboutus_restaurant.jpg" alt="a photo of a restaurant" />
...
<main class="aboutus-counter">
	...
	<div class="aboutus-counter__mini-card-wrapper">
		<div class="aboutus-counter__mini-card">
			<img class="aboutus-counter__illustration-img" src="images/assets/images/aboutus_counter/happy.png" alt="an illustration of a happy person" />
			<div>
				<span>8000</span>
				<p>Happy Users</p>
			</div>
			<img class="aboutus-counter__arrow-img" src="images/assets/images/aboutus_counter/arrow.png" alt="an illustration of an arrow pointing to the right" />
		</div>
		<div class="aboutus-counter__mini-card">
			<img class="aboutus-counter__illustration-img" src="images/assets/images/aboutus_counter/liked.png" alt="an illustration of hand doing a thumb up gesture" />
			<div>
				<span>10M</span>
		...
		<div class="aboutus-counter__mini-card">
			<img class="aboutus-counter__illustration-img" src="images/assets/images/aboutus_counter/positions.png" alt="an illustration of the globe with multiple pointers" />
			<div>
				<span>100</span>
	...
	<div class="aboutus-counter__fun-fact swiper swiper-fun-fact">
		<div class="swiper-wrapper">
			<img class="swiper-slide" src="images/assets/images/fun_fact_laundry.jpg" alt="a picture of a laundry basket" />
			<img class="swiper-slide" src="images/assets/images/fun_fact_swimmingpool.jpg" alt="an aerial picture of a swimming pool" />
		</div>
